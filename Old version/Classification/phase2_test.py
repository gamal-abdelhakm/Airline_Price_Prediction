...
learnData("airline-tas-classification-test","AdaBoostModel")
learnData("airline-tas-classification-test","TreeModel")
learnData("airline-tas-classification-test","LogisticModel")
